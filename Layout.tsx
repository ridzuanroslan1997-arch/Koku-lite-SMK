...
import { 
  ...
  UserCog, Image as ImageIcon, Briefcase, Trophy, FolderOpen, Bell, ListChecks, CheckSquare, Printer, HelpCircle 
} from 'lucide-react';
...
export const Layout: React.FC<LayoutProps> = ({ 
  ...
  // ADD HELP MENU TO EVERYONE
  menuItems.push({ id: 'help', label: 'Panduan / Manual', icon: HelpCircle });
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row font-sans text-slate-900">
      ...
      <aside className={`
        ...
        md:relative md:translate-x-0 md:shadow-none print:hidden
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-y-auto h-screen bg-slate-50 p-4 md:p-8 scroll-smooth print:bg-white print:p-0 print:overflow-visible print:h-auto">
        {children}
      </main>
    </div>
  );
