            ...
            <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Cloud System (SMK)</p>
                    </div>
                </div>
                
                <h2 className="text-3xl font-bold leading-tight mb-4 text-slate-50">Pengurusan Kokurikulum Digital.</h2>
                <p className="text-slate-400 text-sm leading-relaxed mb-8">
                    Sistem bersepadu untuk sekolah menengah. Rekod kehadiran, laporan aktiviti, dan pencapaian pelajar kini lebih mudah dan pantas.
                </p>
