    ...
    <div className="max-w-6xl mx-auto pb-12">
                ...
                <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl p-6">
                    ...
                    <div className="space-y-4">
                        <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 text-sm text-blue-800 mb-4">
                            Pelajar ini akan didaftarkan terus ke dalam unit <b>{unit.name}</b>.
                        </div>

                        <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Nama Penuh Pelajar</label>
                            <input 
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Tingkatan / Kelas</label>
                            <input 
                            ...
                            <datalist id="class-suggestions">
                                <option value="1 Cemerlang" />
                                <option value="2 Bestari" />
                                <option value="3 Amanah" />
                                <option value="4 Sains" />
                                <option value="4 Akaun" />
                                <option value="5 Kemanusiaan" />
                                <option value="Tingkatan 6 Atas" />
                            </datalist>
                        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-3 bg-gray-100 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-200">
                ...
                <div className="col-span-2">Tingkatan / Kelas</div>
