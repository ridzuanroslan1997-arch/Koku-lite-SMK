...
import { RegisteredTeachersList } from './components/RegisteredTeachersList';
import { HelpManual } from './components/HelpManual'; // NEW IMPORT
...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    if (!hasData && currentView !== 'dashboard' && currentView !== 'upload_trigger' && currentView !== 'su_units' && currentUser.role !== UserRole.GURU_PENASIHAT && currentView !== 'pk_notices' && currentView !== 'help') {
        return (
    ...
    switch (currentView) {
      ...
      // NEW HELP MANUAL ROUTE
      case 'help': return <HelpManual onBack={() => setCurrentView('dashboard')} />;
