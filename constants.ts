...
export const DEMO_SCHOOL_NAME = 'SMK Demo Bistari';
...
export const INITIAL_UNITS: Unit[] = [
  ...
  { id: 'u3', name: 'Kadet Polis', category: UnitCategory.BADAN_BERUNIFORM, schoolId: DEMO_SCHOOL_ID },
  { id: 'u4', name: 'Persatuan Bahasa Melayu', category: UnitCategory.KELAB_PERSATUAN, schoolId: DEMO_SCHOOL_ID },
  { id: 'u5', name: 'Kelab STEM & Robotik', category: UnitCategory.KELAB_PERSATUAN, schoolId: DEMO_SCHOOL_ID },
